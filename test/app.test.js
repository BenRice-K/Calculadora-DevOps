...
test("lanza error si falta una nota", () => {
  expect(() => calcularPromedio(60, 70, 75)).toThrow("Todas las notas son requeridas");
});

test("lanza error si nota fuera de rango", () => {
  expect(() => calcularPromedio(60, 70, 75, 101)).toThrow("Las notas deben estar entre 1 y 100");
});

test("lanza error si nota es menor a 1", () => {
  expect(() => calcularPromedio(0, 70, 75, 80)).toThrow("Las notas deben estar entre 1 y 100");
});